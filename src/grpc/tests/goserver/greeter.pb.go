...
var file_greeter_proto_rawDesc = []byte{
	...
	0x16, 0x70, 0x68, 0x70, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x22, 0x1d, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x03, 0x6d, 0x73, 0x67, 0x32, 0x53, 0x0a, 0x03, 0x53, 0x61, 0x79, 0x12, 0x4c, 0x0a, 0x05, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x1f, 0x2e, 0x70, 0x68, 0x70, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f,
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x2e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x70, 0x68, 0x70, 0x2e, 0x6d, 0x69, 0x63, 0x72,
	0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x2e, 0x52,
...
var file_greeter_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: php.micro.grpc.greeter.Request
	(*Response)(nil), // 1: php.micro.grpc.greeter.Response
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: php.micro.grpc.greeter.Say.Hello:input_type -> php.micro.grpc.greeter.Request
	1, // 1: php.micro.grpc.greeter.Say.Hello:output_type -> php.micro.grpc.greeter.Response
...
func (c *sayClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/php.micro.grpc.greeter.Say/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Say_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/php.micro.grpc.greeter.Say/Hello",
	}
...
var _Say_serviceDesc = grpc.ServiceDesc{
	ServiceName: "php.micro.grpc.greeter.Say",
