...
MixPHP 是一个小巧但功能强大的 Swoole 框架，他并不极致的追求全异步、非阻塞、协程这些不太友好的黑科技。依然采用 PHPer 所熟知的同步开发方式，只专注通过常驻内存打造一个更加简单、实用的 Swoole 框架。让更多初/中级 PHPer 也能享受到 Swoole 带来的高性能与全新的编程体验。

MixPHP 的专注使得他在不使用黑科技的情况下，依然拥有超高性能。

MixPHP 极致追求简单、实用主义，试图让使用过传统 MVC 框架的 PHPer 们只需几天即可学会使用。
